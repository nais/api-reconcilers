...
// AddMemberToGroup provides a mock function for the type MockClient
func (_mock *MockClient) AddMemberToGroup(ctx context.Context, grp *Group, member *Member) error {
	ret := _mock.Called(ctx, grp, member)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *Group, *Member) error); ok {
		r0 = returnFunc(ctx, grp, member)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_c *MockClient_AddMemberToGroup_Call) Return(err error) *MockClient_AddMemberToGroup_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockClient_AddMemberToGroup_Call) RunAndReturn(run func(ctx context.Context, grp *Group, member *Member) error) *MockClient_AddMemberToGroup_Call {
	_c.Call.Return(run)
	return _c
}

// CreateGroup provides a mock function for the type MockClient
func (_mock *MockClient) CreateGroup(ctx context.Context, grp *Group) (*Group, error) {
	ret := _mock.Called(ctx, grp)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, *Group) (*Group, error)); ok {
		return returnFunc(ctx, grp)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *Group) *Group); ok {
		r0 = returnFunc(ctx, grp)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*Group)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, *Group) error); ok {
		r1 = returnFunc(ctx, grp)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
func (_c *MockClient_CreateGroup_Call) Return(group *Group, err error) *MockClient_CreateGroup_Call {
	_c.Call.Return(group, err)
	return _c
}

func (_c *MockClient_CreateGroup_Call) RunAndReturn(run func(ctx context.Context, grp *Group) (*Group, error)) *MockClient_CreateGroup_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteGroup provides a mock function for the type MockClient
func (_mock *MockClient) DeleteGroup(ctx context.Context, grpID uuid.UUID) error {
	ret := _mock.Called(ctx, grpID)
...
func (_c *MockClient_DeleteGroup_Call) RunAndReturn(run func(ctx context.Context, grpID uuid.UUID) error) *MockClient_DeleteGroup_Call {
	_c.Call.Return(run)
	return _c
}

// GetGroupById provides a mock function for the type MockClient
func (_mock *MockClient) GetGroupById(ctx context.Context, id uuid.UUID) (*Group, error) {
	...
	var r0 *Group
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) (*Group, error)); ok {
		return returnFunc(ctx, id)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) *Group); ok {
...
func (_c *MockClient_GetGroupById_Call) Return(group *Group, err error) *MockClient_GetGroupById_Call {
	_c.Call.Return(group, err)
	return _c
}

func (_c *MockClient_GetGroupById_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID) (*Group, error)) *MockClient_GetGroupById_Call {
	_c.Call.Return(run)
	return _c
}

// GetOrCreateGroup provides a mock function for the type MockClient
func (_mock *MockClient) GetOrCreateGroup(ctx context.Context, naisTeam *protoapi.Team, groupName string) (*Group, bool, error) {
	ret := _mock.Called(ctx, naisTeam, groupName)
	...
	var r1 bool
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *protoapi.Team, string) (*Group, bool, error)); ok {
		return returnFunc(ctx, naisTeam, groupName)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *protoapi.Team, string) *Group); ok {
		r0 = returnFunc(ctx, naisTeam, groupName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*Group)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, *protoapi.Team, string) bool); ok {
		r1 = returnFunc(ctx, naisTeam, groupName)
	} else {
		r1 = ret.Get(1).(bool)
	}
	if returnFunc, ok := ret.Get(2).(func(context.Context, *protoapi.Team, string) error); ok {
		r2 = returnFunc(ctx, naisTeam, groupName)
	} else {
		r2 = ret.Error(2)
	}
	return r0, r1, r2
...
func (_c *MockClient_GetOrCreateGroup_Call) Run(run func(ctx context.Context, naisTeam *protoapi.Team, groupName string)) *MockClient_GetOrCreateGroup_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 *protoapi.Team
		if args[1] != nil {
			arg1 = args[1].(*protoapi.Team)
		}
		var arg2 string
		if args[2] != nil {
			arg2 = args[2].(string)
...
func (_c *MockClient_GetOrCreateGroup_Call) Return(group *Group, b bool, err error) *MockClient_GetOrCreateGroup_Call {
	_c.Call.Return(group, b, err)
	return _c
}

func (_c *MockClient_GetOrCreateGroup_Call) RunAndReturn(run func(ctx context.Context, naisTeam *protoapi.Team, groupName string) (*Group, bool, error)) *MockClient_GetOrCreateGroup_Call {
	_c.Call.Return(run)
	return _c
}

// GetUser provides a mock function for the type MockClient
func (_mock *MockClient) GetUser(ctx context.Context, email string) (*Member, error) {
...
func (_c *MockClient_GetUser_Call) Return(member *Member, err error) *MockClient_GetUser_Call {
	_c.Call.Return(member, err)
	return _c
}

func (_c *MockClient_GetUser_Call) RunAndReturn(run func(ctx context.Context, email string) (*Member, error)) *MockClient_GetUser_Call {
	_c.Call.Return(run)
	return _c
}

// ListGroupMembers provides a mock function for the type MockClient
func (_mock *MockClient) ListGroupMembers(ctx context.Context, grp *Group) ([]*Member, error) {
	ret := _mock.Called(ctx, grp)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, *Group) []*Member); ok {
		r0 = returnFunc(ctx, grp)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*Member)
...
func (_c *MockClient_ListGroupMembers_Call) Return(members []*Member, err error) *MockClient_ListGroupMembers_Call {
	_c.Call.Return(members, err)
	return _c
}

func (_c *MockClient_ListGroupMembers_Call) RunAndReturn(run func(ctx context.Context, grp *Group) ([]*Member, error)) *MockClient_ListGroupMembers_Call {
	_c.Call.Return(run)
	return _c
}

// ListGroupOwners provides a mock function for the type MockClient
func (_mock *MockClient) ListGroupOwners(ctx context.Context, grp *Group) ([]*Member, error) {
	ret := _mock.Called(ctx, grp)
...
func (_c *MockClient_ListGroupOwners_Call) Return(members []*Member, err error) *MockClient_ListGroupOwners_Call {
	_c.Call.Return(members, err)
	return _c
}

func (_c *MockClient_ListGroupOwners_Call) RunAndReturn(run func(ctx context.Context, grp *Group) ([]*Member, error)) *MockClient_ListGroupOwners_Call {
	_c.Call.Return(run)
	return _c
}

// RemoveMemberFromGroup provides a mock function for the type MockClient
func (_mock *MockClient) RemoveMemberFromGroup(ctx context.Context, grp *Group, member *Member) error {
	ret := _mock.Called(ctx, grp, member)
...
func (_c *MockClient_RemoveMemberFromGroup_Call) Return(err error) *MockClient_RemoveMemberFromGroup_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockClient_RemoveMemberFromGroup_Call) RunAndReturn(run func(ctx context.Context, grp *Group, member *Member) error) *MockClient_RemoveMemberFromGroup_Call {
	_c.Call.Return(run)
	return _c
}
