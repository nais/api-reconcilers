...
type Config struct {
	...
	AuditLog struct {
		...
		// LoggkamelEndpoint The base URL of the loggkamel API used to determine whether a team requires onprem audit logging.
		LoggkamelEndpoint string `env:"LOGGKAMEL_ENDPOINT"`
	}
